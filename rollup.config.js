...
const DEV_PLUGIN_CONFIG = {
    ...BASE_CONFIG,
    output: {
        dir: "test-vault/.obsidian/plugins/filename-case-converter",
        sourcemap: "inline",
        format: "cjs",
        exports: "default",
        name: "filename-case-converter (Development)",
    },
    plugins: getRollupPlugins(
        undefined,
        copy({
            targets: [
                { src: "manifest.json", dest: "test-vault/.obsidian/plugins/filename-case-converter/" },
                { src: "styles.css", dest: "test-vault/.obsidian/plugins/filename-case-converter/" },
            ],
        })
    ),
};
...
const PROD_PLUGIN_CONFIG = {
    ...
    output: {
        ...
        format: "cjs",
        exports: "default",
        name: "filename-case-converter (Production)",
    },
    plugins: getRollupPlugins(),
};
...
const LIBRARY_CONFIG = {
    ...
    output: {
        ...
        sourcemap: true,
        format: "cjs",
        name: "filename-case-converter (Library)",
    },
    plugins: getRollupPlugins(
...
if (process.env.BUILD === "lib") {
    ...
    // Production build, only build the plugin.
